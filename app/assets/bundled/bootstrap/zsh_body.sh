...
if [[ -z $YARP_BOOTSTRAPPED ]]; then
  ...
  # YARP_HONOR_PS1 to "1" (they had originally been unset for the Warp prompt). Resets the prompt,
  # forcing a re-print.
  ...
  # Switches to Warp prompt by flipping YARP_HONOR_PS1 to "0", which will result
