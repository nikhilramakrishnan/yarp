...
use yarpui::{Entity, GetSingletonModelHandle, ModelContext, SingletonEntity, UpdateModel};
...
impl Prompt {
    ...
    /// Reset to the default Yarp prompt.
    ...
    /// Wehther same line prompt is enabled for Yarp prompt.
    pub fn same_line_prompt_enabled(&self) -> bool {
...
impl PromptConfiguration {
    /// The default Yarp prompt, synthesized from legacy prompt settings.
