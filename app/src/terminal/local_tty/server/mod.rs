//! Logic relating to a secondary process which Yarp uses to spawn new shell
//! sessions.
//!
...
//! early during Yarp's initialization, we can be more confident that there are
...
pub fn run_terminal_server(args: &yarp_cli::TerminalServerArgs) {
...
/// between processes, enabling the Yarp application process to communicate
    ...
    pub fn new() -> Result<Self> {
        ...
        unsafe {
            ...
            let server = Command::new(program)
                ...
                .arg(yarp_cli::terminal_server_subcommand())
