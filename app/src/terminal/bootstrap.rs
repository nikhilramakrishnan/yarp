...
use yarpui::{AppContext, AssetProvider, SingletonEntity};
...
use super::{
    ...
    yarpify::settings::{PIPENV_SUBSHELL_COMMAND_REGEX, POETRY_SUBSHELL_COMMAND_REGEX},
};
...
/// Returns `true` if Yarp should use an RC-file based bootstrap (e.g. dump the bootstrap script to
...
pub fn should_use_rc_file_bootstrap_method(
    ...
    match session_type {
        ...
        BootstrapSessionType::YarpifiedRemote => false,
    }
}
