...
impl TerminalView {
    ...
    fn revoke_roles_on_inactivity_period_expired(&mut self, ctx: &mut ViewContext<Self>) {
        ...
        if num_executors > 0 {
            ...
            self.show_persistent_toast(
                "Channel went quiet — write privileges have been revoked.".to_owned(),
                ToastFlavor::Error,
                ctx,
            );
        }
    ...
    pub fn maybe_show_role_changed_toast(
        ...
        {
            self.show_persistent_toast(
                "Channel went quiet — write privileges pulled while the holder was off-air."
                    .to_owned(),
                ToastFlavor::Error,
                ctx,
            );
    ...
    pub fn render_input_request_edit_access_button(
        ...
        appearance
            ...
            .with_text_label("Request the radio".into())
            .build()
