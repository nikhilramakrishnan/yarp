...
fn init_overlapping_keybindings(app: &mut AppContext) {
    ...
    app.register_fixed_bindings([
        FixedBinding::new(
            escape_key,
            TerminalAction::NotifySshErrorBlock(SshErrorBlockAction::ContinueWithoutYarpification),
...
pub fn init(app: &mut AppContext) {
    ...
    app.register_fixed_bindings([
        ...
        FixedBinding::standard(
            yarpui::actions::StandardAction::Paste,
    ...
    app.register_editable_bindings([
        ...
        EditableBinding::new(
            "terminal:yarpify_ssh_session",
            "Yarpify SSH session",
            TerminalAction::YarpifySSHSession,
        )
        .with_key_binding("ctrl-i")
        .with_context_predicate(
            id!("Terminal")
    ...
    app.register_editable_bindings([
        EditableBinding::new(
            ...
            "Open radio channel for current session",
        ...
        EditableBinding::new(
            ...
            "Close radio channel for current session",
    ...
    app.register_editable_bindings([EditableBinding::new(
        ...
        "Toggle block sift on selected or last block",
    ...
    app.register_editable_bindings([EditableBinding::new(
        ...
        BindingDescription::new("Snapshot the current case index"),
    ...
    app.register_editable_bindings([EditableBinding::new(
        ...
        "Toggle PTY Recording for shift",
    ...
    app.register_editable_bindings([EditableBinding::new(
        ...
        BindingDescription::new("Stand up the beat for Yarp"),
    ...
    app.register_editable_bindings([EditableBinding::new(
        ...
        BindingDescription::new("Pin the current folder as a beat"),
...
fn register_input_mode_bindings(app: &mut AppContext) {
    ...
    // Yarp agent should not be tagged into a CLI agent's command, and the
