...
impl EnvironmentSetupModeSelector {
    ...
    fn render_header(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let title = Text::new(
            "Pick how you'd like to set up the beat".to_string(),
    ...
    fn render_option(
        ...
        Hoverable::new(mouse_state, move |state| {
            ...
            if is_suggested {
                let suggested_text =
                    Text::new("Top pick".to_string(), font_family, OPTION_DESC_FONT_SIZE)
    ...
    fn render_modal(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        let remote_github_option = self.render_option(
            ...
            Icon::Github,
            "Quick briefing",
            "Pick the GitHub repos you want on the case and we'll suggest a base image and Standing Orders",
            true,
