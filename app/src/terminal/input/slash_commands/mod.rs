                    ...
                    "user=\"${{USER:-unknown}}\"; \
                     ...
                     if [ \"$n\" -gt 0 ]; then \
                       ...
                       if [ -z \"$callsign\" ] && [ \"$for_others\" -gt 0 ]; then \
                         ...
                         printf '  \\033[2;38;5;244m%-10s\\033[0m 📨 \\033[38;5;178m%s\\033[0m \\033[3;38;5;244m— /duty <name> to read\\033[0m\\n' 'for others' \"$others_summary\"; \
                       fi; \
                     else \
                       hour=$(date +%H); \
                       case \"$hour\" in \
                ...
                let cmd = "shopt -s nullglob; \
                    ...
                    if [ ${#files[@]} -eq 0 ]; then \
                      if [ \"${pruned:-0}\" -gt 0 ]; then \
                        ...
                        printf '\\033[3;38;5;244m📻 INBOX\\033[0m\\033[1;38;5;179m%s\\033[0m \\033[3;38;5;244m no traffic\\033[0m\\n' \"$me_hdr\"; \
                      fi; \
