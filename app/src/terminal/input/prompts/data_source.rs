...
use yarpui::elements::{ConstrainedBox, Container, Highlight, Text};
use yarpui::fonts::{Properties, Weight};
use yarpui::text_layout::ClipConfig;
use yarpui::{AppContext, Element, Entity, ModelContext, ModelHandle, SingletonEntity as _};

use crate::appearance::Appearance;
use crate::cloud_object::model::persistence::CloudModel;
use crate::search::command_palette::yarp_drive;
...
pub struct PromptsMenuDataSource {
    yarp_drive_data_source: ModelHandle<yarp_drive::DataSource>,
}
...
impl PromptsMenuDataSource {
    pub fn new(ctx: &mut ModelContext<Self>) -> Self {
        ...
        let yarp_drive_data_source = ctx.add_model(yarp_drive::DataSource::new_fuzzy);
        Self {
            yarp_drive_data_source,
        }
    }
}
...
impl SearchItem for PromptSearchItem {
    ...
    fn item_background(
        ...
        appearance: &Appearance,
    ) -> Option<yarp_core::ui::theme::Fill> {
