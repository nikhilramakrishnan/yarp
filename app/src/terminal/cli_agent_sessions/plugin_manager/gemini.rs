// yarp: the upstream extension marketplace lived at
// https://github.com/hotfuzz/gemini-cli-yarp, a GitHub org that doesn't
// exist. The auto-install/update flow would 404, so this stub disables it
// and falls back to the trait's default behavior:
