...
use yarpui::ui_components::components::{Coords, UiComponent as _, UiComponentStyles};
use yarpui::{AppContext, Element, Entity, SingletonEntity as _, View, ViewContext, ViewHandle};
...
use yarp_graphql::error::BudgetExceededError;
    ...
    fn render_auto_reload_blocked(
        ...
        if has_admin_permissions {
            let manage_billing_button = appearance
                ...
                .with_text_label("Manage the ledger".to_string())
                .build()
                .on_click(|ctx, _, _| {
            ...
            if is_at_monthly_limit || would_purchase_exceed_limit {
                ...
                .register_default_click_handlers_with_action_support(
                    |hyperlink_lens, event, _ctx| match hyperlink_lens {
                        yarpui::elements::HyperlinkLens::Url(_url) => {}
    ...
    fn render(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        match display_state {
            BuyCreditsBannerDisplayState::Hidden => {
                Container::new(yarpui::elements::Empty::new().finish()).finish()
            }
...
impl yarpui::TypedActionView for BuyCreditsBanner {
    type Action = Action;
