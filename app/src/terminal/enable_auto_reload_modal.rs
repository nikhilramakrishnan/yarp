...
impl EnableAutoReloadModalBody {
    ...
    fn render_content(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let explanation_text = yarpui::elements::FormattedTextElement::new(
        ...
        .register_default_click_handlers_with_action_support(|hyperlink_lens, _event, ctx| {
            match hyperlink_lens {
                ...
                yarpui::elements::HyperlinkLens::Action(_action_ref) => {}
            }
        })
        .finish();
...
impl yarpui::TypedActionView for EnableAutoReloadModalBody {
    type Action = Action;
...
impl yarpui::TypedActionView for EnableAutoReloadModal {
    type Action = ();
}
