...
pub const SSH_DOCS_URL: &str = "https://github.com/hotfuzz/yarp/terminal/yarpify/ssh";
pub const SUBSHELL_DOCS_URL: &str = "https://github.com/hotfuzz/yarp/terminal/yarpify/subshells";
...
pub fn render_subshell_flag_pole(
    max_height: f32,
    fill: impl Into<yarpui::elements::Fill>,
) -> Box<dyn Element> {
