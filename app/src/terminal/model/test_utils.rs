...
///
/// ```no_run
/// # use yarp::terminal::model::test_utils::TestBlockListBuilder;
...
///
/// ```no_run
/// # use yarp::terminal::event::{BlockType, Event};
/// # use yarp::terminal::event_listener::ChannelEventListener;
/// # use yarp::terminal::model::block::SerializedBlock;
/// # use yarp::terminal::model::test_utils::TestBlockListBuilder;
///
...
impl<'a> TestBlockListBuilder<'a> {
    ...
    pub fn build(self) -> BlockList {
        let mut block_list = BlockList::new(
            ...
            false, /* show_yarp_bootstrap_input */
            false, /* show_yarp_bootstrap_input */
...
///
/// ```no_run
/// # use yarp::terminal::model::test_utils::TestBlockBuilder;
