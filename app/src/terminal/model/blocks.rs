...
pub struct BlockList {
    ...
    show_yarp_bootstrap_block: bool,
...
impl BlockList {
    ...
    /// `create_yarp_input_block`. From here on, there is always a default
    ...
    fn new_internal(
        ...
        BlockList {
            ...
            background_executor,
            show_yarp_bootstrap_block: show_yarp_bootstrap_input,
            show_in_band_command_blocks,
            show_memory_stats,
            honor_ps1,
    ...
    fn create_yarp_input_block(&mut self) {
    ...
    pub fn append_rich_content(
            ...
            && insert_below_long_running_block
        {
            ...
            // until it's started. This is an invariant of the blocklist (see create_yarp_input_block). In this
    ...
    /// `create_yarp_input_block`. For non-block items before then, we should
    ...
    /// Attaches every non-fuzz-startup block in the list to `conversation_id` so each block is
    ...
    pub fn set_show_bootstrap_block(&mut self, show_bootstrap_block: bool) {
        self.show_yarp_bootstrap_block = show_bootstrap_block;
        self.update_blocks_and_sumtree(
            None,
            None,
    ...
    fn seek_down_to_next_grid(
        ...
        match grid_type {
            GridType::Output => {
                ...
                // vs the next "command" (in the Yarp prompt case), when using the combined grid, rather than
    ...
    fn create_new_block(
        ...
        let mut block = Block::new(
            ...
            bootstrap_stage,
            self.show_yarp_bootstrap_block,
    ...
    fn clear_screen(&mut self, mode: ClearMode) {
        ...
        match mode {
            ...
            ClearMode::All => {
                ...
                // Yarp's custom logic for "clear". It's not immediately straightforward because a
                ...
                // quite right with Yarp's custom clear screen logic.
            }
            _ => {}
        }
