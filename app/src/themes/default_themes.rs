...
pub(super) fn dracula() -> YarpTheme {
    YarpTheme::new(
...
pub(super) fn solarized_light() -> YarpTheme {
    YarpTheme::new(
...
pub(super) fn solarized_dark() -> YarpTheme {
    YarpTheme::new(
...
pub(super) fn gruvbox_dark() -> YarpTheme {
    YarpTheme::new(
...
pub(super) fn gruvbox_light() -> YarpTheme {
    YarpTheme::new(
...
pub(super) fn cyber_wave() -> YarpTheme {
    YarpTheme::new(
...
pub(super) fn willow_dream() -> YarpTheme {
    YarpTheme::new(
        Fill::VerticalGradient(VerticalGradient::new(
...
pub(super) fn fancy_dracula() -> YarpTheme {
    YarpTheme::new(
        Fill::VerticalGradient(VerticalGradient::new(
...
pub(super) fn phenomenon() -> YarpTheme {
    YarpTheme::new(
...
pub(super) fn jellyfish() -> YarpTheme {
    YarpTheme::new(
...
pub(super) fn pink_city() -> YarpTheme {
...
pub(super) fn red_rock() -> YarpTheme {
    YarpTheme::new(
        Fill::VerticalGradient(VerticalGradient::new(
...
pub(super) fn dark_city() -> YarpTheme {
    YarpTheme::new(
        Fill::VerticalGradient(VerticalGradient::new(
...
pub(super) fn sent_referral_reward() -> YarpTheme {
    YarpTheme::new(
        ...
        Some("Yarp Referral".to_string()),
    )
}

pub(super) fn solar_flare() -> YarpTheme {
    YarpTheme::new(
...
pub(super) fn adeberry() -> YarpTheme {
    YarpTheme::new(
...
pub(super) fn received_referral_reward() -> YarpTheme {
    YarpTheme::new(
