...
use yarpui::{fonts::Weight, rendering::ThinStrokes, AppContext, SingletonEntity};

use settings::{
    macros::define_settings_group, RespectUserSyncSetting, Setting, SupportedPlatforms, SyncToCloud,
};
use yarpui::elements::DEFAULT_UI_LINE_HEIGHT_RATIO;
...
define_settings_group!(FontSettings,
    settings: [
        monospace_font_name: MonospaceFontName {
            ...
            description: "The monospace font used in beat output.",
        },
        monospace_font_size: MonospaceFontSize {
            ...
            description: "The size of the monospace font in beat output.",
        },
        monospace_font_weight: MonospaceFontWeight {
            ...
            description: "The weight of the monospace font in beat output.",
        },
        line_height_ratio: LineHeightRatio {
            ...
            description: "The line height ratio for beat text.",
        },
        ai_font_name: AIFontName {
            ...
            description: "The font used for the PC's content.",
        },
        match_ai_font_to_terminal_font: MatchAIFontToTerminalFont {
            ...
            description: "Whether the PC font automatically matches the beat font.",
        },
        notebook_font_size: NotebookFontSize {
            ...
            description: "The font size used in casebooks.",
        },
        match_notebook_to_monospace_font_size: MatchNotebookToMonospaceFontSize {
            ...
            description: "Whether the casebook font size matches the beat font size.",
        },
