...
define_settings_group!(InputSettings,
    settings: [
        show_hint_text: ShowHintText {
            ...
            description: "Whether hint text is shown in the beat input.",
        },
        ...
        syntax_highlighting: SyntaxHighlighting {
            ...
            description: "Whether syntax highlighting is enabled in the beat input.",
        },
        ...
        input_box_type: InputBoxTypeSetting {
            ...
            description: "The beat input style.",
        },
        at_context_menu_in_terminal_mode: AtContextMenuInTerminalMode {
            ...
            description: "Whether the @ context menu is available in desk mode.",
        },
        enable_slash_commands_in_terminal: EnableSlashCommandsInTerminal {
            ...
            description: "Whether slash commands are available in the beat input.",
        },
        ...
        // Whether to show the beat input message bar (contextual hints at the bottom of beat input).
        ...
        show_terminal_input_message_bar: ShowTerminalInputMessageBar {
            ...
            description: "Whether the beat input message bar is shown.",
        },
