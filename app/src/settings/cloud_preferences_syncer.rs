...
/// Handles syncing CloudPreferences (the Yarp Drive objects) and local Settings models that
...
impl CloudPreferencesSyncer {
    ...
    pub fn sync(
        ...
        PrivacySettings::handle(ctx).update(ctx, |privacy_settings, ctx| {
            ...
            privacy_settings.maybe_sync_with_yarp_drive_prefs(ctx);
        });
    }
