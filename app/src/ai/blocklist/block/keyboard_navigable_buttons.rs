...
pub type ButtonBuilder = Box<dyn Fn(bool, &yarpui::AppContext) -> Button>;
...
impl KeyboardNavigableButtonBuilder {
    pub fn new(
        button_builder: impl Fn(bool, &yarpui::AppContext) -> Button + 'static,
...
pub fn simple_navigation_button<A: yarpui::Action + Clone + 'static>(
    text_label: String,
...
pub fn rich_navigation_button<A: yarpui::Action + Clone + 'static>(
    text_label: String,
...
impl View for KeyboardNavigableButtons {
    ...
    fn keymap_context(&self, _app: &AppContext) -> yarpui::keymap::Context {
