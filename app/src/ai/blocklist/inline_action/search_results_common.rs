...
use yarpui::{AppContext, EventContext, SingletonEntity};
...
pub fn render_search_results_header(
    ...
    is_expanded: bool,
    mouse_state: yarpui::elements::MouseStateHandle,
    ...
    yarpui::elements::Hoverable::new(mouse_state, |_| inner)
