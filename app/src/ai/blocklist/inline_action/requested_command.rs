...
use yarpui::elements::{ConstrainedBox, ScrollbarWidth};
use yarpui::ui_components::components::UiComponent as _;
use yarpui::{
    elements::{
...
use yarpui::{EntityId, EventContext};
...
pub struct RequestedCommandView {
    ...
    // A requested command can either be copied directly off of one citation (such as a Yarp Drive
            ...
            (
                ...
                *shown.lock() = true;
                Some(render_autonomy_checkbox_setting_speedbump_footer(
                    "Standing orders: let Taskforce run read-only call-outs (officer's discretion)",
                    *checked,
        ...
        if self.is_accept_split_button_menu_open {
            root_stack.add_positioned_child(
                ...
                OffsetPositioning::offset_from_save_position_element(
                    ...
                    yarpui::elements::PositionedElementAnchor::BottomRight,
                    yarpui::elements::ChildAnchor::TopRight,
                ),
            );
        }
