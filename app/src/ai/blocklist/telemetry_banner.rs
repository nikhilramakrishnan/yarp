...
const DESCRIPTION: &str = "We may log a few station interactions to keep Yarp's AI sharp. Stand down any time.";
            ...
            .with_child(
                Container::new(
                    ui_builder
                        ...
                        .with_text_label("Pull the dossier".into())
            ...
            .with_child(
                Container::new(
                    ui_builder
                        ...
                        .with_text_label("Amend privacy Standing Orders".into())
                        .with_style(UiComponentStyles {
                            ..Default::default()
                        })
                        .build()
