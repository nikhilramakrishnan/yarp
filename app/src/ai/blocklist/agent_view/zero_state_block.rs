...
use yarp_core::{features::FeatureFlag, report_if_error, ui::Icon};
use yarpui::{
    elements::{
            ...
            Shrinkable::new(
                ...
                Clipped::new(
                    Align::new(
                        ...
                        .on_click(|_, app, _| {
                            const CHANGELOG_URL: &str = "https://github.com/hotfuzz/yarp/changelog";
...
pub fn render_ambient_credits_banner(credits: i32, app: &AppContext) -> Box<dyn Element> {
    ...
    let credits_text = format!("{credits} free cloud-patrol rations");
