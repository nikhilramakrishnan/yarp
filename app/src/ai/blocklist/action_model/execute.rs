...
use yarp_core::{execution_mode::AppExecutionMode, features::FeatureFlag};
...
#[cfg(feature = "local_fs")]
use yarp_files::{FileModel, TextFileReadResult};
#[cfg(feature = "local_fs")]
use yarp_util::file::FileLoadError;
#[cfg(feature = "local_fs")]
use yarp_util::file_type::is_buffer_binary;
use yarpui::{
...
/// Async sibling of [`yarp_util::file_type::is_file_content_binary`]. Reads
...
/// module so `yarp_util` doesn't need to grow an `async_fs` dependency.
#[cfg(feature = "local_fs")]
