...
//!   Claude conversation: the Yarp server conversation id to reuse, the Claude session uuid
...
pub(crate) struct ClaudeResumeInfo {
    /// The Yarp server-side conversation id. The runner stores this instead of calling
