...
use yarpui::elements::new_scrollable::{
...
pub fn init(app: &mut AppContext) {
    ...
    app.register_fixed_bindings([FixedBinding::new(
        ...
        yarpui::keymap::macros::id!(AgentManagementView::ui_name()),
    )]);
}
    ...
    pub fn new(
        ...
        let all_filter_button = ctx.add_typed_action_view(|_ctx| {
            ActionButton::new("All", NakedTheme)
                ...
                .with_tooltip("Watch your case files plus every shared team case")
                .on_click(|ctx| {
    ...
    fn render_cloud_loading_icon(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        Hoverable::new(self.loading_icon_mouse_state.clone(), move |mouse_state| {
            ...
            if mouse_state.is_hovered() {
                let tooltip = ui_builder
                    .tool_tip(String::from("Calling in ambient officer patrols"))
                    .build()
                    .finish();
                stack.add_positioned_overlay_child(
                    tooltip,
