...
use yarpui::{View, ViewContext, ViewHandle};

use yarp_core::ui::appearance::Appearance as CoreAppearance;
...
pub(crate) type OnExpandClick = Box<dyn Fn(&mut yarpui::EventContext)>;
