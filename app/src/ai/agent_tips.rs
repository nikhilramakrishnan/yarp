...
static DEFAULT_TIPS: LazyLock<Vec<AgentTip>> = LazyLock::new(|| {
    vec![
        ...
        AgentTip {
            description: "<keybinding> to open the Command Palette and access Yarp actions and shortcuts.".to_string(),
        ...
        AgentTip {
            description: "`@` to add context from files, blocks, or Yarp Drive objects to your prompt.".to_string(),
        ...
        AgentTip {
            description: "Yarpify a remote SSH session to enable Fuzz inside that environment.".to_string(),
