//! This module contains Rust types for the GenerateAMQuerySuggestions endpoint in yarp-server that
//! serves Agent Mode.
//!
//! These types are manually transposed from the API schema defined in go
//! (yarp-server/model/types/generate_am_query_suggestions/(request.go|response.go|common.go)).
//!
