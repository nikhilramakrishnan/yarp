...
impl From<UserQueryMode> for yarp_multi_agent_api::UserQueryMode {
    fn from(value: UserQueryMode) -> Self {
        match value {
            UserQueryMode::Normal => yarp_multi_agent_api::UserQueryMode { r#type: None },
            UserQueryMode::Plan => yarp_multi_agent_api::UserQueryMode {
                r#type: Some(yarp_multi_agent_api::user_query_mode::Type::Plan(())),
            },
            UserQueryMode::Orchestrate => yarp_multi_agent_api::UserQueryMode {
                r#type: Some(yarp_multi_agent_api::user_query_mode::Type::Orchestrate(())),
            },
        }
    }
}
    ...
    fn try_from(action_result: AIAgentActionResult) -> Result<Self, Self::Error> {
        let result = match action_result.result {
            ...
            AIAgentActionResultType::OpenCodeReview => Some(
                yarp_multi_agent_api::request::input::tool_call_result::Result::OpenCodeReview(
                    yarp_multi_agent_api::OpenCodeReviewResult {},
                ),
            ),
            ...
            AIAgentActionResultType::InitProject => Some(
                yarp_multi_agent_api::request::input::tool_call_result::Result::InitProject(
                    yarp_multi_agent_api::InitProjectResult {},
                ),
            ),
