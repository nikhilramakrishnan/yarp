...
use yarpui::{AppContext, EntityId, SingletonEntity as _};
...
pub struct RequestParams {
    ...
    pub yarp_drive_context_enabled: bool,
...
impl RequestParams {
    pub fn new(
        ...
        let yarp_drive_context_enabled = ai_settings.is_yarp_drive_context_enabled(app);
        ...
        let allow_use_of_yarp_credits_with_byok =
            *AISettings::as_ref(app).can_use_yarp_credits_with_byok;
        ...
        Self {
            ...
            api_keys,
            allow_use_of_yarp_credits_with_byok,
            autonomy_level,
            isolation_level,
            web_search_enabled,
