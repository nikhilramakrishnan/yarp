...
use yarpui::{Element, EventContext};
    ...
    fn icon_color(&self, appearance: &Appearance) -> ColorU {
        match self {
            ...
            QueryFilter::Conversations | QueryFilter::HistoricalConversations => appearance
                ...
                .main_text_color(appearance.theme().surface_2())
                .into_solid(),
            QueryFilter::Workflows => yarp_drive_icon_color(appearance, DriveObjectType::Workflow),
            QueryFilter::Notebooks => yarp_drive_icon_color(
                appearance,
                DriveObjectType::Notebook {
                    is_ai_document: false,
                },
            ),
            QueryFilter::Plans => yarp_drive_icon_color(
                appearance,
                DriveObjectType::Notebook {
                    is_ai_document: true,
                },
