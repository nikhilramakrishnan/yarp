...
use crate::drive::settings::{YarpDriveSettings, YarpDriveSettingsChangedEvent};
...
impl CommandSearchZeroStateView {
    pub fn new(ctx: &mut ViewContext<Self>) -> Self {
        ...
        ctx.subscribe_to_model(&YarpDriveSettings::handle(ctx), |_, _, event, ctx| {
