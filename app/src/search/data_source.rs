...
impl QueryFilter {
    ...
    pub fn placeholder_text(&self) -> &'static str {
        match self {
            QueryFilter::History => "Sweep history",
            QueryFilter::Workflows => "Sweep playbooks",
            QueryFilter::AgentModeWorkflows => "Sweep prompts",
            QueryFilter::Notebooks => "Sweep casebooks",
            QueryFilter::Plans => "Sweep plans",
            QueryFilter::NaturalLanguage => "e.g. replace string in file",
            QueryFilter::Actions => "Sweep actions",
            QueryFilter::Sessions => "Sweep sessions",
            QueryFilter::Conversations => "Sweep case files",
            QueryFilter::HistoricalConversations => "Sweep closed case files",
            QueryFilter::LaunchConfigurations => "Sweep launch configurations",
            QueryFilter::Drive => "Sweep objects in drive",
            QueryFilter::EnvironmentVariables => "Sweep environment variables",
            QueryFilter::PromptHistory => "Sweep prompt history",
            QueryFilter::Files => "Sweep files",
    ...
    pub fn icon_svg_path(&self) -> Option<&'static str> {
        match self {
            ...
            QueryFilter::Drive => Some("bundled/svg/yarp-drive.svg"),
