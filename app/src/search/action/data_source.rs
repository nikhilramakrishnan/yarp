...
use yarpui::keymap::{BindingId, DescriptionContext};
...
// Context on why the search_drive action is excluded can be seen here: https://github.com/hotfuzz/yarp/pull/11705
