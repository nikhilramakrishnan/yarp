...
use yarp_editor::{content::buffer::InitialBufferState, render::model::LineCount};
use yarp_util::file::{FileLoadError, FileSaveError};
use yarpui::{
...
impl View for LocalCodeEditorView {
    ...
    fn render(&self, _app: &AppContext) -> Box<dyn Element> {
        yarpui::elements::Empty::new().finish()
    }
}
