...
use yarpui::{platform::SaveFilePickerConfiguration, ModelHandle};
    ...
    fn fetch_definition_for_hover(
        ...
        self.call_goto_definition(
            ...
            move |me, definition_result, ctx| {
                ...
                let on_click: Box<dyn Fn(&mut yarpui::AppContext)> = if has_different_definition {
    ...
    let right = Flex::row()
        ...
        .with_child(
            appearance
                ...
                .with_text_label("Bin this draft".into())
        ...
        .with_child(
            Container::new(
                appearance
                    ...
                    .with_text_label("Stamp it down".into())
                    .with_style(UiComponentStyles {
                        font_color: Some(appearance.theme().active_ui_text_color().into()),
                        ..Default::default()
                    })
