...
use yarp_editor::search::{SearchEvent, Searcher};
use yarpui::elements::MainAxisAlignment;
use yarpui::elements::{ChildAnchor, OffsetPositioning, Radius, SavePosition, Shrinkable};
...
use yarpui::{presenter::ChildView, ViewContext, ViewHandle};
use yarpui::{FocusContext, ModelHandle};
...
impl View for CodeEditorFind {
    ...
    fn on_blur(&mut self, _blur_ctx: &yarpui::BlurContext, ctx: &mut ViewContext<Self>) {
