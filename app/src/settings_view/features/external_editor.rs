...
impl ExternalEditorView {
    ...
    fn init_layout_dropdown(
        ...
        match layout_to_open_files {
            ...
            EditorLayout::NewTab => dropdown.set_selected_by_name("New beat", ctx),
        };
    }
    ...
    fn init_editor_dropdown(
        ...
        items.push(DropdownItem::new("Yarp", make_action(EditorChoice::Yarp)));
        ...
        match editor_to_open_files {
            ...
            EditorChoice::Yarp => dropdown.set_selected_by_name("Yarp", ctx),
...
impl View for ExternalEditorView {
    ...
    fn render(&self, app: &yarpui::AppContext) -> Box<dyn yarpui::Element> {
        ...
        column.add_child(render_body_item::<ExternalEditorAction>(
            "Open Markdown files in Yarp's Markdown Viewer by default".to_string(),
            Some(AdditionalInfo {
                mouse_state: self.markdown_viewer_mouse_state.clone(),
                on_click_action: Some(ExternalEditorAction::OpenUrl(
                    "https://github.com/hotfuzz/yarp/terminal/more-features/markdown-viewer".to_string(),
                )),
                secondary_text: None,
