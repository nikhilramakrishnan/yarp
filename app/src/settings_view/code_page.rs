            ...
            let open_rules_button = ui_builder
                ...
                .with_text_and_icon_label(
                    yarpui::ui_components::button::TextAndIcon::new(
                        ...
                        yarpui::elements::MainAxisSize::Min,
                        yarpui::elements::MainAxisAlignment::Center,
        ...
        if is_failed {
            if let Some(server_handle) = server_model.cloned() {
                ...
                let restart_button = ui_builder
                    ...
                    .with_text_label("Sign back on".to_owned())
                    .build()
                    .with_cursor(Cursor::PointingHand)
                    .on_click(move |ctx, _, _| {
        ...
        #[cfg(not(target_family = "wasm"))]
        {
            ...
            if has_logs {
                ...
                let view_logs_button = ui_builder
                    ...
                    .with_text_label("Pull the logs".to_owned())
                    .build()
                    .with_cursor(Cursor::PointingHand)
                    .on_click(move |ctx, _, _| {
            ...
            Some(model) => {
                ...
                match server.state() {
                    ...
                    LspState::Stopped { .. } | LspState::Stopping { .. } => {
                        (theme.disabled_ui_text_color().into_solid(), "Off duty")
                    }
                }
            }
            None => (theme.disabled_ui_text_color().into_solid(), "Stood down"),
        }
    }
}
