...
pub mod flags {
    ...
    pub const YARP_SAME_LINE_PROMPT_FLAG: &str = "Yarp_Same_Line_Prompt_Enabled";
...
pub struct SettingsView {
    ...
    /// per `SettingsView` per `YARP.md`'s guidance that inline
...
impl SettingsView {
    pub fn new(page: Option<SettingsSection>, ctx: &mut ViewContext<Self>) -> Self {
        let pane_configuration = ctx.add_model(|_ctx| PaneConfiguration::new("Logbook"));
        ...
        let search_editor = ctx.add_typed_action_view(|ctx| {
            ...
            editor.set_placeholder_text("Look up the playbook", ctx);
            editor
        });
...
impl View for SettingsView {
    ...
    fn render(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        // (e.g. Fuzz -> AI, AgentMCPServers -> MCPServers).
...
impl BackingView for SettingsView {
    ...
    fn render_header_content(
        ...
        view::HeaderContent::simple("Logbook")
    }
