...
use yarpui::platform::GraphicsBackend;
use yarpui::rendering::GPUPowerPreference;
use yarpui::{elements::DispatchEventResult, platform::Cursor};
#[cfg(target_os = "linux")]
use {
    crate::settings::ForceX11, crate::settings::LinuxAppConfiguration,
    yarpui::platform::linux::windowing_system_is_customizable,
};
...
use yarp_core::semantic_selection::{
...
use yarpui::keymap::{ContextPredicate, FixedBinding, Keystroke};
    ...
    fn handle_action(&mut self, action: &FeaturesPageAction, ctx: &mut ViewContext<Self>) {
        ...
        match action {
            ...
            ToggleForceX11 => {
                ...
                self.page.scroll_by(yarpui::units::Pixels::new(40.));
                ctx.notify();
            }
            ToggleQuitOnLastWindowClosed => {
                GeneralSettings::handle(ctx).update(ctx, |settings, ctx| {
...
impl FeaturesPageView {
    pub fn new(
        ...
        // TODO(CORE-3029): Remove when we launch the new SSH Yarpification.
...
impl SettingsPageMeta for FeaturesPageView {
    ...
    fn on_page_selected(&mut self, _: bool, ctx: &mut ViewContext<Self>) {
        // On MacOS, we rely on [`yarpui::platform::AppCallbacks::on_screen_changed`] to update and
...
impl SettingsWidget for LinkTooltipWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            "Flash a tooltip when you hit a link".into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for QuitWarningModalWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            "Sound the warning before quitting/signing off".into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for QuitWhenAllWindowsClosedWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            "Clock off when all patrol cars are parked".into(),
            None,
            LocalOnlyIconState::for_setting(
        ...
        Flex::column()
            .with_children([
                render_sub_sub_header(
                    appearance,
                    "Default shell for new beats".to_string(),
    ...
    fn render(
        ...
        Flex::column()
            .with_children([
                render_sub_sub_header(
                    appearance,
                    "Working directory for new beats".to_string(),
                    Some(LocalOnlyIconState::for_setting(
...
impl SettingsWidget for AutosuggestionKeybindingHintWidget {
    ...
    fn render(
        ...
        column.add_child(render_body_item::<FeaturesPageAction>(
            "Flash the autosuggestion keybinding hint".into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for AutosuggestionIgnoreButtonWidget {
    ...
    fn render(
        ...
        let show_autosuggestion_ignore_button = *app_editor_settings
            ...
            .value();
        column.add_child(render_body_item::<FeaturesPageAction>(
            "Show the autosuggestion stand-down button".into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for ShowTerminalZeroStateBlockWidget {
    ...
    fn render(
        ...
        let terminal_settings = TerminalSettings::as_ref(app);
        render_body_item::<FeaturesPageAction>(
            "Show the briefing block on new tours".into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for DefaultSessionModeWidget {
    ...
    fn render(
        ...
        let label = render_dropdown_item_label(
            "Default mode for new beats".to_string(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for WorkflowsInCommandSearch {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            "Show Global Playbooks in Command Sweep (ctrl-r)".into(),
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
                on_click_action: Some(FeaturesPageAction::OpenUrl(
...
impl SettingsWidget for GPUWidget {
    ...
    fn render(
        ...
        let mut col = Flex::column().with_child(render_body_item::<FeaturesPageAction>(
            "Prefer rolling out new patrol cars on the integrated GPU (low power)".into(),
            None,
            LocalOnlyIconState::for_setting(
        ...
        if view.gpu_power_preference_changed {
            ...
            col.add_child(
                Container::new(
                    appearance
                        .ui_builder()
                        .wrappable_text("New beats will pick up the order.", true)
                        .with_style(UiComponentStyles {
