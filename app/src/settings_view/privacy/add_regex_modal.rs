...
use yarpui::elements::{CrossAxisAlignment, Expanded, MainAxisSize};
use yarpui::{
...
impl AddRegexModal {
    pub fn new(ctx: &mut ViewContext<Self>) -> Self {
        ...
        let name_editor = ctx.add_typed_action_view(|ctx| {
            ...
            editor.set_placeholder_text("e.g. \"Google badge number\"", ctx);
            editor
        });
...
impl View for AddRegexModal {
    ...
    fn render(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        let mut add_button = appearance
            ...
            .with_text_label("File the redaction".to_string())
