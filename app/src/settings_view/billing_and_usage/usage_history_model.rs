...
use yarp_graphql::scalars::Time;

const PAGE_SIZE: i32 = 20;

pub struct UsageHistoryModel {
    auth_client: Arc<dyn AuthClient>,
    entries: Vec<yarp_graphql::queries::get_conversation_usage::ConversationUsage>,
    is_loading: bool,
...
impl UsageHistoryModel {
    ...
    pub fn entries(&self) -> &[yarp_graphql::queries::get_conversation_usage::ConversationUsage] {
        &self.entries
    }
