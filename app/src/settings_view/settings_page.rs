...
pub enum SettingsPageViewHandle {
    ...
    Council(ViewHandle<CouncilPageView>),
...
impl SettingsPageViewHandle {
    pub fn child_view(&self) -> Box<dyn Element> {
        ...
        match self {
            ...
            Council(view_handle) => ChildView::new(view_handle).finish(),
...
/// [`SettingsWidget`]s.
pub(super) enum PageType<V: yarpui::View> {
...
pub(super) enum FilteredPageType<'a, V: yarpui::View> {
    Monolith {
...
pub(super) struct Category<V: yarpui::View> {
    title: &'static str,
    subtitle: Option<&'static str>,
    widgets: Vec<Box<dyn SettingsWidget<View = V>>>,
}

impl<V: yarpui::View> Category<V> {
    pub(super) fn new(
        title: &'static str,
        widgets: Vec<Box<dyn SettingsWidget<View = V>>>,
    ) -> Self {
...
pub(super) struct FilteredCategory<'a, V: yarpui::View> {
...
pub(super) fn build_reset_button(
    ...
    appearance
        ...
        .with_text_label("Restore standard issue".to_owned())
}
