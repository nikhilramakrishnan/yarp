...
impl View for ExecutionProfileView {
    ...
    fn render(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        .with_border(
            yarpui::elements::Border::new(1.).with_border_fill(appearance.theme().outline()),
        )
        .with_corner_radius(yarpui::elements::CornerRadius::with_all(
            ...
            items_vec
                ...
                .map(|item| {
                    Container::new(
                        ...
                        .with_background(appearance.theme().surface_2())
                        .with_border(
                            yarpui::elements::Border::all(1.)
                                .with_border_fill(appearance.theme().outline()),
                        )
                        .with_corner_radius(yarpui::elements::CornerRadius::with_all(
                            yarpui::elements::Radius::Pixels(3.),
                        ))
...
fn render_allowlist_denylist_row(
    ...
    .with_margin_left(8.)
    .with_border(yarpui::elements::Border::left(1.).with_border_fill(appearance.theme().outline()))
    .with_padding_left(8.)
    .finish()
}
