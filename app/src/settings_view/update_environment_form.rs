...
use yarp_graphql::queries::user_github_info::UserGithubInfoResult;
use yarpui::{
    elements::{
...
impl UpdateEnvironmentForm {
    ...
    fn new_impl(
        ...
        let submit_button = ctx.add_typed_action_view(|_| {
            ActionButton::new("Open the beat", PrimaryTheme)
        ...
        let delete_button = ctx.add_typed_action_view(|_| {
            ActionButton::new("Strike the beat", DangerSecondaryTheme)
            ...
            move |me, result, ctx| {
                ...
                match result {
                    Ok(result) => match result {
                        yarp_graphql::queries::suggest_cloud_environment_image::SuggestCloudEnvironmentImageResult::SuggestCloudEnvironmentImageOutput(output) => {
                        ...
                        yarp_graphql::queries::suggest_cloud_environment_image::SuggestCloudEnvironmentImageResult::SuggestCloudEnvironmentImageAuthRequiredOutput(output) => {
                        ...
                        yarp_graphql::queries::suggest_cloud_environment_image::SuggestCloudEnvironmentImageResult::UserFacingError(_) => {
                        ...
                        yarp_graphql::queries::suggest_cloud_environment_image::SuggestCloudEnvironmentImageResult::Unknown => {
        ...
        if self.should_show_share_with_team_checkbox(app) {
            ...
            let label = Hoverable::new(
                ...
                move |state| {
                    ...
                    Text::new_inline("Share with the squad", font_family, font_size)
    ...
    fn build_auth_url_with_next_internal(
        ...
        let scheme_for_next = std::env::var("YARP_OAUTH_NEXT_SCHEME")
            .ok()
    ...
    fn oauth_next_scheme() -> String {
        if let Ok(override_value) = std::env::var("YARP_OAUTH_NEXT_SCHEME") {
...
impl TypedActionView for UpdateEnvironmentForm {
    ...
    ) -> yarpui::accessibility::ActionAccessibilityContent {
        yarpui::accessibility::ActionAccessibilityContent::default()
    }
}
