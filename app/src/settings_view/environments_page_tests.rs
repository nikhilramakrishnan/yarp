...
use yarpui::{App, AppContext, Element, Entity, TypedActionView, View, WindowId};
...
fn make_test_environment_with_timestamps(
    ...
    github_repos: Vec<(String, String)>,
    setup_commands: Vec<String>,
    last_edited_ts: Option<yarp_graphql::scalars::time::ServerTimestamp>,
    last_used_ts: Option<yarp_graphql::scalars::time::ServerTimestamp>,
) -> EnvironmentDisplayData {
    EnvironmentDisplayData {
...
fn test_render_list_page_with_personal_and_team_environments_shows_section_headers() {
    App::test((), |mut app| async move {
        ...
        app.update(|ctx| {
            ...
            // shared header copy ("Shared by Yarp and <team>").
