...
pub fn init_actions_from_parent_view<T: Action + Clone>(
    ...
    app.register_fixed_bindings(vec![FixedBinding::empty(
        "Start the radio mic at the top".to_string(),
        builder(SettingsAction::AppearancePageToggle(
    ...
    app.register_fixed_bindings(vec![FixedBinding::empty(
        "Pin the radio mic to the top".to_string(),
        builder(SettingsAction::AppearancePageToggle(
            AppearancePageAction::SetInputMode {
    ...
    app.register_fixed_bindings(vec![FixedBinding::empty(
        "Pin the radio mic to the bottom".to_string(),
        builder(SettingsAction::AppearancePageToggle(
            AppearancePageAction::SetInputMode {
    ...
    app.register_fixed_bindings(vec![FixedBinding::empty(
        "Toggle the radio mic mode (Yarp/Classic)".to_string(),
        builder(SettingsAction::AppearancePageToggle(
        ...
        toggle_binding_pairs.push(
            ToggleSettingActionPair::custom(
                SettingActionPairDescriptions::new(
                    "Show the casebook review button in the beat bar",
                    "Hide the casebook review button in the beat bar",
                ),
                builder(SettingsAction::AppearancePageToggle(
    ...
    if FeatureFlag::FullScreenZenMode.is_enabled() {
        ...
        app.register_fixed_bindings([
            FixedBinding::empty(
                "Always show the beat bar".to_string(),
                builder(SettingsAction::AppearancePageToggle(
            ...
            .with_group(bindings::BindingGroup::Settings.as_str()),
            FixedBinding::empty(
                "Hide the beat bar in fullscreen".to_string(),
                builder(SettingsAction::AppearancePageToggle(
                    AppearancePageAction::SetWorkspaceDecorationVisibility(
            ...
            .with_group(bindings::BindingGroup::Settings.as_str()),
            FixedBinding::empty(
                "Only show the beat bar on hover".to_string(),
                builder(SettingsAction::AppearancePageToggle(
                    AppearancePageAction::SetWorkspaceDecorationVisibility(
...
pub struct AppearanceSettingsPageView {
    ...
    /// selected Yarp prompt configuration.
...
impl AppearanceSettingsPageView {
    ...
    fn input_mode_dropdown_item_label(val: InputMode) -> &'static str {
        match val {
            InputMode::PinnedToBottom => "Pin to the bottom (Yarp mode)",
...
impl SettingsWidget for CustomWindowSizeWidget {
    ...
    fn render(
        ...
        let mut column = Flex::column().with_child(render_body_item::<AppearancePageAction>(
            "Open new patrol cars at custom size".into(),
            None,
            LocalOnlyIconState::for_setting(
    ...
    fn render(
        ...
        let label_info = AdditionalInfo {
            ...
            on_click_action: Some(AppearancePageAction::OpenUrl(
                "https://github.com/hotfuzz/yarp/terminal/appearance/size-opacity-blurring".into(),
            )),
            secondary_text: None,
...
impl SettingsWidget for ToolsPanelStateScopeWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            "Keep the tools panel on the same channel across tabs".to_string(),
            None,
            LocalOnlyIconState::for_setting(
                ...
                Flex::row()
                    ...
                    .with_child(
                        Shrinkable::new(
                            ...
                            appearance
                                .ui_builder()
                                .span("Look through all the system fonts".to_string())
                                .build()
                                .with_margin_left(2.)
                                .finish(),
                        )
...
impl SettingsWidget for CodeReviewButtonWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            "Show casebook review button".into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for PreserveActiveTabColorWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            "Hold the active beat colour over to fresh beats".into(),
            None,
            LocalOnlyIconState::for_setting(
    ...
    fn render(
        ...
        let mut column = Flex::column().with_child(render_body_item::<AppearancePageAction>(
            ...
            Some(AdditionalInfo {
                ...
                on_click_action: Some(AppearancePageAction::OpenUrl(
                    "https://github.com/hotfuzz/yarp/terminal/more-features/full-screen-apps#padding".into(),
                )),
                secondary_text: None,
                tooltip_override_text: None,
            }),
