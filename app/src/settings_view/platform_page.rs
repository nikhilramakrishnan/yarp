                        ...
                        me.api_keys = keys
                            ...
                            .map(|gql_key| {
                                ...
                                let scope = match gql_key.owner_type {
                                    yarp_graphql::object_permissions::OwnerType::User => {
                                        ApiKeyScope::Personal
                                    }
                                    yarp_graphql::object_permissions::OwnerType::Team => {
                                        ApiKeyScope::Team
                                    }
                                };
        ...
        match event {
            ...
            CreateApiKeyModalEvent::Created { api_key } => {
                ...
                let scope = match api_key.owner_type {
                    yarp_graphql::object_permissions::OwnerType::User => ApiKeyScope::Personal,
                    yarp_graphql::object_permissions::OwnerType::Team => ApiKeyScope::Team,
                };
...
impl PlatformPageWidget {
    fn render_description_with_link(
        ...
        let text = vec![
            FormattedTextFragment::plain_text("Create and manage API keys to allow other Oz cloud agents to access your Yarp account.\nFor more information, visit the "),
