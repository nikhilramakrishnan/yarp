...
pub(crate) enum SidecarItemKind {
    /// A built-in item (Terminal, a specific shell, Agent, Cloud Fuzz).
    BuiltIn {
        name: String,
...
pub(crate) fn render_action_sidecar(
    ...
    let button_style = UiComponentStyles {
        ...
        padding: Some(yarpui::ui_components::components::Coords {
            top: 4.,
            bottom: 4.,
            left: 8.,
            right: 8.,
    ...
    let make_default_button = if is_already_default {
        ...
        appearance
            ...
            .with_centered_text_label("Set as standard issue".into())
        ...
        appearance
            ...
            .on_click(move |ctx: &mut yarpui::elements::EventContext, _, _| {
    ...
    if let SidecarItemKind::UserTabConfig { config } = item {
        if let Some(config_path) = &config.source_path {
            ...
            let edit_button = appearance
                ...
                .with_centered_text_label("Amend kit".into())
                .with_style(button_style)
                .build()
                .with_cursor(Cursor::PointingHand)
                .on_click(move |ctx: &mut yarpui::elements::EventContext, _, _| {
            ...
            let remove_button = appearance
                ...
                .with_centered_text_label("Strike off".into())
