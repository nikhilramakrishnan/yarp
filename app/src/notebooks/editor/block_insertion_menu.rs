...
use yarp_editor::content::text::BufferBlockItem;
use yarpui::{
    elements::{
...
impl BlockInsertionMenuState {
    ...
    fn create_menu(
            ...
            menu.add_item(
                MenuItemFields::new(block_type.label())
                    ...
                    .with_on_select_action(EditorViewAction::InsertBlock(
                        yarp_editor::content::text::BlockType::Text(block_type.into()),
                    ))
                    .into_item(),
            );
        }
        ...
        menu.add_item(
            MenuItemFields::new("Beat marker")
                .with_icon(Icon::HorizontalRuleBlock)
                .with_on_select_action(EditorViewAction::InsertBlock(
                    yarp_editor::content::text::BlockType::Item(BufferBlockItem::HorizontalRule),
                ))
...
impl RichTextEditorView {
    ...
    fn insert_embedded_workflow(&mut self, id: &SyncId, ctx: &mut ViewContext<Self>) {
        self.insert_block(
            yarp_editor::content::text::BlockType::Item(BufferBlockItem::Embedded {
    ...
    fn render_button(&self, stack: &mut Stack, app: &AppContext) {
        ...
        .with_tooltip(move || {
            ui_builder
                .tool_tip("File a new case file".to_string())
                .build()
                .finish()
        })
