...
use yarp_core::ui::{builder::CHECK_SVG_PATH, theme::color::internal_colors};
use yarp_editor::{
    content::text::{
...
use yarpui::{elements::Border, fonts::FamilyId, ui_components::checkbox::HOVER_BACKGROUND_COLOR};
...
/// within a notebook.
///
/// This may be a command block that's part of the notebook text, or an embedded Yarp Drive workflow.
