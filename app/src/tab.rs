...
impl TabData {
    ...
    fn session_sharing_menu_items(
            ...
            && ContextFlag::CreateSharedSession.is_enabled()
        {
            ...
            if let Some(focused_session_view) = focused_session_view {
                ...
                {
                    menu_items.push(
                        MenuItemFields::new("Close radio channel")
                    ...
                    menu_items.push(
                        MenuItemFields::new("Open radio channel")
            ...
            if !shared_session_view_ids.is_empty() {
                menu_items.push(
                    MenuItemFields::new("Close all radio channels")
    ...
    fn modify_tab_menu_items(
        ...
        menu_items.append(&mut vec![MenuItemFields::new("Rename beat")
        ...
        if title.is_some() {
            menu_items.push(
                MenuItemFields::new("Strike beat name from the books")
    ...
    fn close_tab_menu_items(
        ...
        if tabs_len > 1 {
            menu_items.push(
                MenuItemFields::new("Close other beats")
    ...
    fn save_config_menu_items(index: usize) -> Vec<MenuItem<WorkspaceAction>> {
        ...
        vec![MenuItemFields::new("Lodge a new duty roster")
                    ...
                    Hoverable::new(mouse_state, move |state| {
                        ...
                        if state.is_hovered() {
                            let tooltip = ui_builder
                                .tool_tip("Ambient officer on duty".to_string())
                                .build()
                                .finish();
