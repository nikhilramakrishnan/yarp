...
use yarp_graphql::billing::{AddonCreditAutoReloadStatus, ServiceAgreement, ServiceAgreementType};
...
impl Workspace {
    ...
    pub fn get_auto_reload_price_cents(
        &self,
        addon_credits_options: &[yarp_graphql::billing::AddonCreditsOption],
    ) -> Option<i32> {
...
impl BillingMetadata {
    ...
    // Whether the enterprise customer is our Stable Yarp Enterprise team (internal team of Yarpers).
    pub fn is_yarp_plan(&self) -> bool {
