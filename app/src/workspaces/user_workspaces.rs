...
use yarp_graphql::workspace::FeatureModelChoice;
use yarpui::{AppContext, Entity, ModelContext, SingletonEntity, Tracked};
...
pub struct WorkspacesMetadataWithPricing {
    ...
    pub pricing_info: Option<yarp_graphql::billing::PricingInfo>,
}
...
impl UserWorkspaces {
    ...
    pub fn is_at_tier_limit_for_some_yarp_drive_objects(
        team_uid: ServerId,
        ctx: &AppContext,
    ) -> bool {
    ...
    /// are on the Yarp Plan or the build is dogfood (both our internal Yarp team and dogfood
