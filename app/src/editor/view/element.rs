...
use instant::Instant;
use yarpui::elements::{Radius, DEFAULT_UI_LINE_HEIGHT_RATIO};
...
impl EditorElement {
        ...
        for cursor in cursors {
            ...
            if !is_local {
                    ...
                    remote_selections_data.get_mut(&cursor.replica_id)
                {
                    ...
                    ctx.scene.start_layer(yarpui::ClipBounds::None);
    ...
    pub fn with_input_editor_icons(
        ...
        let cycle_next_command_hint = if self.should_show_cycle_next_command_hint(is_cycling, ctx) {
            ...
            Some(
                self.render_cycle_next_command_hint(yarp_core::ui::theme::Fill::Solid(
