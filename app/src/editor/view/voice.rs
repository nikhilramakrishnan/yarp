...
use yarpui::elements;
use yarpui::elements::{Container, CornerRadius, Icon, Radius};
...
use yarpui::{AppContext, Element, SingletonEntity, ViewContext};
...
impl EditorView {
        ...
        ctx.subscribe_to_view(&voice_new_feature_popup, |_me, _, event, ctx| {
            if matches!(
                ...
                AISettings::handle(ctx).update(ctx, |settings, ctx| {
                    yarp_core::report_if_error!(settings
            ...
            voice_input::VoiceInputToggledFrom::Key { state } => {
                ...
                match &self.voice_input_state {
                    ...
                    VoiceInputState::Stopped => {
                        if matches!(state, yarpui::event::KeyState::Released) {
                            return false;
                        }
                    }
                    ...
                    VoiceInputState::Listening => {
                        if matches!(state, yarpui::event::KeyState::Pressed) {
                            return false;
                        }
                    }
                    _ => {}
    ...
    fn render_voice_transcription_button_tooltip(
        ...
        let mic_access_denied = matches!(
            ...
            yarpui::platform::MicrophoneAccessState::Restricted
                | yarpui::platform::MicrophoneAccessState::Denied
        );
    ...
    pub(super) fn render_voice_transcription_button(
        ...
        yarpui::elements::SavePosition::new(
            button
                .build()
