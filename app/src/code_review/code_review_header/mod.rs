...
use yarpui::elements::{Hoverable, ParentElement};
...
impl CodeReviewHeader {
    ...
    fn create_branch_name_element(
        ...
        Container::new(
            yarpui::elements::Text::new_inline(
                header_text,
        ...
        let mut button_builder = appearance
            ...
            .with_text_and_icon_label(
                TextAndIcon::new(
                    ...
                    Icon::ReverseLeft.to_warpui_icon(yarp_core::ui::theme::Fill::Solid(
    ...
    fn render_add_diff_set_context_button(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let button = ui_builder
            ...
            .with_text_and_icon_label(TextAndIcon::new(
                TextAndIconAlignment::IconFirst,
                "",
                Icon::Paperclip.to_warpui_icon(yarp_core::ui::theme::Fill::Solid(
            ...
            .with_tooltip_position(yarpui::ui_components::button::ButtonTooltipPosition::AboveLeft)
            .build()
            .on_click(|ctx, _, _| {
