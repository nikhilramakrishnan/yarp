    ...
    fn default(appearance: &Appearance) -> YarpDriveItemStyles {
        ...
        YarpDriveItemStyles {
            ...
            dragged: UiComponentStyles::default()
                ...
                .set_background(
                    yarp_core::ui::theme::color::internal_colors::fg_overlay_4(theme).into(),
                )
            ...
            hovered: UiComponentStyles::default()
                ...
                .set_background(
                    yarp_core::ui::theme::color::internal_colors::fg_overlay_2(theme).into(),
                ),
        }
    }
}
...
impl<'a> YarpDriveRow<'a> {
    ...
    fn render_item_name(&self, style: UiComponentStyles) -> Box<dyn Element> {
        Span::new(
            self.item
                .display_name()
                .unwrap_or_else(|| "Unfiled item".to_string()),
            style,
        )
        .build()
        .finish()
