...
pub struct OpenYarpDriveObjectSettings {
    /// The folder that should be focused in the Yarp Drive when the object is opened.
...
pub struct OpenYarpDriveObjectArgs {
    pub object_type: ObjectType,
    pub server_id: ServerId,
    pub settings: OpenYarpDriveObjectSettings,
}
...
/// Enum used for sorting elements in the Yarp Drive Index (and potentially other places).
