...
const UNSAVED_CHANGES_TEXT: &str = "You've got unfiled amendments.";
const KEEP_EDITING_TEXT: &str = "Keep at it";
const DISCARD_CHANGES_TEXT: &str = "Bin the amendments";
...
impl WorkflowModal {
    ...
    fn populate(&mut self, workflow: Workflow, ctx: &mut ViewContext<Self>) {
        ...
        // Necessary since Yarp AI command search sometimes provides arguments in an invalid argument format.
    ...
    fn menu_items(&self, app: &AppContext) -> Vec<MenuItem<WorkflowModalAction>> {
        ...
        menu_items.push(
            MenuItemFields::new("Bag the playbook as text")
