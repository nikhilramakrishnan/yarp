...
pub(super) struct WorkspaceMouseStates {
    ...
    pub(super) yarp_logo: MouseStateHandle,
}
    ...
    pub fn is_any_non_palette_modal_open(&self, app: &AppContext) -> bool {
        self.is_theme_creator_modal_open
            ...
            || {
                ...
                one_time_modal.is_fuzz_launch_modal_open()
...
/// that.
///
/// Note that "active" is not the same as "focused" in Yarp's pane management.
