...
const REPO_URL: &str = "https://github.com/hotfuzz/yarp";
const CONTRIBUTING_URL: &str = "https://github.com/hotfuzz/yarp/blob/master/CONTRIBUTING.md";
...
const FEATURE_ITEMS: &[FeatureItem] = &[
    ...
    FeatureItem {
        ...
        description: "The Yarp repo is run PC-first, dispatched by Taskforce, our ambient officer orchestration platform.",
        inline_link: None,
    },
    FeatureItem {
...
impl OpenYarpLaunchModal {
    ...
    fn render_title(appearance: &Appearance) -> Box<dyn Element> {
        Text::new("Yarp is now open-source", appearance.ui_font_family(), 20.)
