...
use yarpui::accessibility::AccessibilityVerbosity;
use yarpui::elements::DropTargetData;
use yarpui::keymap::FixedBinding;
use yarpui::keymap::{BindingDescription, EditableBinding};
...
pub fn panel_header_corner_radius() -> yarpui::elements::CornerRadius {
    yarpui::elements::CornerRadius::with_top(yarpui::elements::Radius::Pixels(8.))
}
...
pub fn init(app: &mut AppContext) {
    ...
    view::launch_modal::fuzz_launch::init(app);
    ...
    if ChannelState::enable_debug_features() {
        ...
        #[cfg(debug_assertions)]
        {
            ...
            app.register_editable_bindings([
                ...
                .with_context_predicate(id!("Workspace")),
                EditableBinding::new(
                    "workspace:install_opencode_yarp_plugin",
                    "[Debug] Install OpenCode Yarp plugin",
                    WorkspaceAction::InstallOpenCodeYarpPlugin,
                )
                .with_context_predicate(id!("Workspace")),
                EditableBinding::new(
                    "workspace:use_local_opencode_yarp_plugin",
    ...
    app.register_fixed_bindings([
        ...
        FixedBinding::custom(
            ...
            BindingDescription::new("Toggle the beat directory")
                .with_custom_description(bindings::MAC_MENUS_CONTEXT, "Beat Directory"),
    ...
    app.register_editable_bindings([
        ...
        EditableBinding::new(
            ...
            BindingDescription::new("File a new squad playbook")
                .with_custom_description(bindings::MAC_MENUS_CONTEXT, "New Squad Playbook"),
        ...
        EditableBinding::new(
            ...
            BindingDescription::new("File a new personal playbook")
                .with_custom_description(bindings::MAC_MENUS_CONTEXT, "New Personal Playbook"),
        ...
        EditableBinding::new(
            ...
            BindingDescription::new("Walk onto a new beat"),
            WorkspaceAction::AddDefaultTab,
        )
        ...
        EditableBinding::new(
            ...
            BindingDescription::new("Open case file cabinet"),
        ...
        EditableBinding::new(
            ...
            BindingDescription::new("Left Panel: Case files"),
        ...
        EditableBinding::new(
            ...
            BindingDescription::new("Left Panel: Beat directory"),
            WorkspaceAction::ToggleProjectExplorer,
        )
        .with_group(bindings::BindingGroup::Navigation.as_str())
        ...
        EditableBinding::new(
            ...
            BindingDescription::new("Left Panel: Stationhouse sweep"),
        ...
        EditableBinding::new(
            ...
            BindingDescription::new("Run a stationhouse sweep")
                .with_custom_description(bindings::MAC_MENUS_CONTEXT, "Stationhouse Sweep"),
        ...
        EditableBinding::new(
            ...
            "Pull up the radio codebook editor",
    ...
    app.register_editable_bindings([
        ...
        EditableBinding::new(
            ...
            BindingDescription::new("Open Settings: About")
                .with_custom_description(bindings::MAC_MENUS_CONTEXT, "About Yarp"),
        ...
        EditableBinding::new(
            ...
            BindingDescription::new("Open Settings: Squad")
                .with_custom_description(bindings::MAC_MENUS_CONTEXT, "Open Squad Settings"),
        ...
        EditableBinding::new(
            ...
            BindingDescription::new("Open Settings: Rations and usage"),
        ...
        EditableBinding::new(
            ...
            BindingDescription::new("Open Settings: Posts"),
...
fn add_overflow_menu_items_as_editable_binding(app: &mut AppContext) {
    ...
    app.register_editable_bindings([
        ...
        EditableBinding::new(
            ...
            "Radio: raise all other stations",
