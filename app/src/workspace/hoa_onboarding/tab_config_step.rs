    ...
    F4: Fn(&mut EventContext, Vector2F) + 'static,
{
    ...
    let description = Text::new(
        "File a reusable starting kit for your beats. Pick a repo, choose a beat type, and optionally attach a worktree. Pull it whenever you want to open a beat with this setup.",
        appearance.ui_font_family(),
        14.,
    )
