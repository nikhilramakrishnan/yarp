...
impl Workspace {
    ...
    pub fn new(
        ...
        // Show the Warp AI warm welcome iff the user hasn't dismissed it nor interacted with Yarp AI before.
        ...
        if open_warp_drive {
            ...
            ctx.spawn(initial_load_complete, move |me, _, ctx| {
                ...
                if CloudModel::as_ref(ctx).has_non_welcome_objects() {
                    ...
                    // After opening Yarp Drive, if we rendered the Warp Home placeholder panel, replace it with one of
    ...
    pub fn open_or_toggle_warp_drive(
        ...
        // AND warp drive wasn't open before. There are other scenarios where we open Yarp Drive like:
