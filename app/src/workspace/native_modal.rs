...
use yarpui::elements::{Align, Container, Empty, Flex, ParentElement};
...
use yarpui::{AppContext, ModelHandle, SingletonEntity, ViewContext};
...
/// Used to show a Yarp-native modal dialog above a [`super::Workspace`]. The first button is [`ButtonVariant::Accent`].
