...
use yarp_graphql::mutations::create_anonymous_user::AnonymousUserType;
use yarpui::windowing::WindowManager;
use yarpui::{AppContext, SingletonEntity, TypedActionView};
...
fn create_anonymous_user(_: &(), ctx: &mut AppContext) {
    ...
    let result =
        yarpui::r#async::block_on(server_api.create_anonymous_user(None, anonymous_user_type));
    match result {
