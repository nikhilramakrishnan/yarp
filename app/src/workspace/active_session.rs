...
use yarpui::{Entity, EntityId, ModelContext, SingletonEntity, WindowId};
...
/// in Yarp from Finder, or when starting from a cloud object). In that case, the `ActiveSession`
