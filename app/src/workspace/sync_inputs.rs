...
use yarpui::{keymap::EditableBinding, AppContext, Entity, EntityId, SingletonEntity, WindowId};
...
pub fn init(app: &mut AppContext) {
    ...
    app.register_editable_bindings(vec![
        ...
        EditableBinding::new(
            ...
            "Toggle pane sync across all beats",
