...
use crate::{
    ...
    drive::{items::YarpDriveItem, CloudObjectTypeAndId},
...
pub trait StringModel: Clone + Debug + PartialEq + Send + Sync + 'static {
    ...
    /// Returns whether to render this model as a YarpDriveItem.
    ...
    S: Serializer<M>,
{
    ...
    fn renders_in_yarp_drive(&self) -> bool {
        self.string_model.renders_in_yarp_drive()
    }
    ...
    fn to_yarp_drive_item(
        ...
        self.string_model.to_yarp_drive_item(id, appearance, object)
    }
}
