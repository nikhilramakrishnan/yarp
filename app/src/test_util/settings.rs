...
pub fn initialize_settings_for_tests(app: &mut App) {
    use yarp_core::execution_mode::ExecutionMode;
...
pub fn initialize_settings_for_tests_with_mode(
    app: &mut App,
    mode: yarp_core::execution_mode::ExecutionMode,
    is_sandboxed: bool,
) {
    use crate::{
        ...
        terminal::{
            ...
            shared_session::settings::SharedSessionSettings, yarpify::settings::YarpifySettings,
            BlockListSettings,
        },
    ...
    use yarp_core::{execution_mode::AppExecutionMode, semantic_selection::SemanticSelection};
    ...
    YarpDriveSettings::register(app);
    ...
    app.update(|ctx| {
        ...
        yarpui_extras::secure_storage::register_noop("test", ctx);
