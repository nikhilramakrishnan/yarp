...
description: Remove a feature flag after it has been rolled out and stabilized in the Yarp codebase.
---

# remove-feature-flag

Remove a feature flag after it has been rolled out and stabilized in the Yarp codebase.
...
Remove the variant from the `FeatureFlag` enum in `yarp_core/src/features.rs`:
...
```bash
rg "YourFeatureName" app/ yarp_core/
```
