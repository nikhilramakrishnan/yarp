...
/// The purpose is cleared later in `handle_converted_yarpui_event` after soft keyboard
...
fn convert_touch_ended(
    ...
    // in handle_converted_yarpui_event after checking if we need to
    ...
    // handle_converted_yarpui_event after soft keyboard logic runs.
...
impl EventLoop {
    ...
    pub fn handle_event(&mut self, evt: Event<CustomEvent>, window_target: &ActiveEventLoop) {
        ...
        match evt {
            ...
            Event::UserEvent(CustomEvent::MomentumScroll { window_id }) => {
                ...
                self.handle_converted_yarpui_event(
                    window_id,
            ...
            Event::WindowEvent {
                ...
                // one with a different scale factor resize the Yarp window to an absurdly small
    ...
    fn handle_window_event(&mut self, window_id: winit::window::WindowId, evt: WindowEvent) {
        ...
        match event {
            ConvertedEvent::Event(event) => {
                self.handle_converted_yarpui_event(window_id, event);
            }
    ...
    fn convert_window_event(
        ...
        match evt {
            ...
            WindowEvent::KeyboardInput {
                ...
                // the appropriate Yarp-side event (ModifierKeyChanged).
    ...
    fn handle_debounced_drag_drop(&mut self, window_id: winit::window::WindowId) {
        ...
        self.handle_converted_yarpui_event(window_id, drag_drop_event);
    }
    ...
    fn handle_converted_yarpui_event(
        &mut self,
        window_id: winit::window::WindowId,
        event: crate::Event,
    ) {
