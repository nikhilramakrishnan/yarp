...
// 18:09:15 [INFO] [yarp_editor::render::model] Initial tree:
// -------- 0.00px / 0 characters --------
...
// 18:09:14 [INFO] [yarp_editor::render::model] Initial tree:
// -------- 0.00px / 0 characters --------
...
fn make_test_cell_layout() -> CellLayout {
    CellLayout {
        ...
        line_caret_positions: vec![vec![
            yarpui::text_layout::CaretPosition {
...
fn test_link_at_offset_uses_cached_cell_links() {
            ...
            vec![
                ...
                FormattedTextFragment {
                    ...
                    styles: FormattedTextStyles {
                        hyperlink: Some(Hyperlink::Url("https://github.com/hotfuzz/yarp".into())),
                        ..Default::default()
                    },
                },
            ],
    ...
    assert_eq!(
        ...
        Some("https://github.com/hotfuzz/yarp".into())
    );
    assert_eq!(
