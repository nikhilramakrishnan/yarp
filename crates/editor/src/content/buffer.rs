...
use yarp_core::{platform::SessionPlatform, safe_error};
...
use yarpui::{EntityId, ModelHandle, elements::ListIndentLevel};
use yarpui::{
    fonts::Weight,
...
impl Buffer {
    ...
    pub(crate) fn from_markdown(
        ...
        let parse_fn = if yarp_core::features::FeatureFlag::MarkdownTables.is_enabled() {
