...
use yarpui::{AppContext, ModelContext, ModelHandle};

use string_offset::CharOffset;
use yarpui::elements::{ListIndentLevel, ListNumbering};
...
pub enum MarkdownStyle<'a> {
    /// The internal Markdown format used in Yarp Drive. References are normalized, so the Markdown
