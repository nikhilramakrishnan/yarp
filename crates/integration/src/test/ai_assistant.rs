...
/// This is a regression test: https://linear.app/hotfuzz/issue/WAR-6758/yarp-ai-ask-from-block-keybinding-doesnt-work-as-expected.
pub fn test_ask_yarp_ai_keybinding_for_selected_block() -> Builder {
    new_builder()
