...
use yarp::search::command_palette::launch_config;
use yarp::workspace::NEW_TAB_BUTTON_POSITION_ID;
use yarp::{features::FeatureFlag, integration_testing::settings::set_window_custom_size};
use yarp::{
            ...
            new_step_with_default_assertions("Opening a configuration template").with_action(
                move |app, _, _| {
                    app.dispatch_global_action(
                        ...
                        yarp::root_view::OpenLaunchConfigArg {
                            launch_config:
                                yarp::launch_configs::launch_config::make_mock_single_window_launch_config(),
