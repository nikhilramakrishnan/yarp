...
/// Icon enum to be used within the app in place of the yarpui::elements::Icon directly. It
...
impl From<Icon> for &'static str {
    fn from(icon: Icon) -> &'static str {
        match icon {
            ...
            Icon::Yarping0 => "bundled/svg/yarp-loading-0.svg",
            Icon::Yarping1 => "bundled/svg/yarp-loading-1.svg",
            Icon::Yarping2 => "bundled/svg/yarp-loading-2.svg",
            Icon::Yarping3 => "bundled/svg/yarp-loading-3.svg",
            Icon::Yarping4 => "bundled/svg/yarp-loading-4.svg",
            Icon::Yarping5 => "bundled/svg/yarp-loading-5.svg",
            Icon::Yarping6 => "bundled/svg/yarp-loading-6.svg",
            Icon::Yarping7 => "bundled/svg/yarp-loading-7.svg",
            Icon::Yarping8 => "bundled/svg/yarp-loading-8.svg",
            Icon::Yarping9 => "bundled/svg/yarp-loading-9.svg",
            Icon::Yarping10 => "bundled/svg/yarp-loading-10.svg",
            Icon::Yarping11 => "bundled/svg/yarp-loading-11.svg",
            ...
            Icon::Fuzz => "bundled/svg/fuzz.svg",
            Icon::OzCloud => "bundled/svg/fuzz-cloud.svg",
