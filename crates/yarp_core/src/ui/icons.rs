...
impl From<Icon> for &'static str {
    fn from(icon: Icon) -> &'static str {
        match icon {
            ...
            Icon::WarpDrive => "bundled/svg/yarp.svg",
            ...
            Icon::Warping0 => "bundled/svg/yarp-loading-0.svg",
            Icon::Warping1 => "bundled/svg/yarp-loading-1.svg",
            Icon::Warping2 => "bundled/svg/yarp-loading-2.svg",
            Icon::Warping3 => "bundled/svg/yarp-loading-3.svg",
            Icon::Warping4 => "bundled/svg/yarp-loading-4.svg",
            Icon::Warping5 => "bundled/svg/yarp-loading-5.svg",
            Icon::Warping6 => "bundled/svg/yarp-loading-6.svg",
            Icon::Warping7 => "bundled/svg/yarp-loading-7.svg",
            Icon::Warping8 => "bundled/svg/yarp-loading-8.svg",
            Icon::Warping9 => "bundled/svg/yarp-loading-9.svg",
            Icon::Warping10 => "bundled/svg/yarp-loading-10.svg",
            Icon::Warping11 => "bundled/svg/yarp-loading-11.svg",
