...
///
/// - stable:      `~/.yarp/remote-server`
/// - preview:     `~/.yarp-preview/remote-server`
/// - dev:         `~/.yarp-dev/remote-server`
/// - local:       `~/.yarp-local/remote-server`
...
///
/// For example, given `https://app.yarp.dev`, returns
/// `https://app.yarp.dev/download/cli`.
