...
use yarp_util::on_cancel::OnCancelFutureExt;
...
impl WatchedFilesRegistry {
    ...
    fn matches(&self, event: &WatchedFileChangeEvent) -> bool {
        ...
        let path_relative = yarp_util::path::normalize_relative_path_for_glob(path_relative);
    ...
    fn pattern_for_relative_pattern(&self, relative_pattern: RelativePattern) -> Option<String> {
        ...
        let prefix = yarp_util::path::normalize_relative_path_for_glob(base_relative);
