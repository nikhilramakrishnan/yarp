use yarp_core::safe_info;
use yarpui::{keymap::Keystroke, Entity, ModelContext, ModelHandle, ViewContext};
...
/// This struct is a wrapper around the VimFSA that turns it into a yarpui::Entity. We want to keep
/// the VimFSA independent of our UI framework, so anything involving yarpui should live here
/// instead.
#[derive(Default)]
pub struct VimModel {
    fsa: VimFSA,
