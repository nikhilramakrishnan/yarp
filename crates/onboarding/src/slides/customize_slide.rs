...
impl CustomizeUISlide {
    ...
    pub(crate) const VISUAL_IMAGE_PATHS: &'static [&'static str] = &[
        ...
        "async/png/onboarding/agent_intention/customize_yarpdrive_vertical.png",
        "async/png/onboarding/agent_intention/customize_yarpdrive_horizontal.png",
        ...
        "async/png/onboarding/terminal_intention/terminal_customize_yarpdrive_vertical.png",
        "async/png/onboarding/terminal_intention/terminal_customize_yarpdrive_horizontal.png",
    ...
    /// When `OpenYarpNewSettingsModes` is enabled, assets depend on the tab layout setting.
                ...
                if !ui.tools_panel_enabled(&intention) {
                    ...
                    if is_agent {
                        match (chip, vertical) {
                            ...
                            (ToolsPanelSubSetting::YarpDrive, true) => "async/png/onboarding/agent_intention/customize_yarpdrive_vertical.png",
                            (ToolsPanelSubSetting::YarpDrive, false) => "async/png/onboarding/agent_intention/customize_yarpdrive_horizontal.png",
                        }
                    } else {
                        ...
                        match (chip, vertical) {
                            ...
                            (ToolsPanelSubSetting::YarpDrive, true) => "async/png/onboarding/terminal_intention/terminal_customize_yarpdrive_vertical.png",
                            (ToolsPanelSubSetting::YarpDrive, false) => "async/png/onboarding/terminal_intention/terminal_customize_yarpdrive_horizontal.png",
                        }
                    }
                }
            }
