...
use yarp_core::ui::{Icon, appearance::Appearance, theme::color::internal_colors};
use yarpui::{
...
fn main() -> yarpui::platform::app::TerminationResult {
    ...
    app_builder.run(move |ctx| {
        ...
        let font_family = yarpui::fonts::Cache::handle(ctx).update(ctx, |cache, _ctx| {
        ...
        ctx.add_window(yarpui::AddWindowOptions::default(), RootView::new);
    })
}
...
impl View for RootView {
    ...
    fn keymap_context(&self, _: &AppContext) -> yarpui::keymap::Context {
        ...
        tooltip::Tooltip.render(
            ...
            tooltip::Params {
                ...
                options: tooltip::Options {
                    keyboard_shortcut: Some(yarpui::keymap::Keystroke {
                        ctrl: true,
                        key: "k".to_string(),
                        ..Default::default()
                    }),
                ...
                self.default_button_row.default.render(
                    ...
                    button::Params {
                        ...
                        options: button::Options {
                            keystroke: Some(yarpui::keymap::Keystroke {
                                ctrl: true,
                                key: "k".to_string(),
                                ..Default::default()
                            }),
        ...
        self.dialog.render(
            ...
            dialog::Params {
                ...
                options: dialog::Options {
                    ...
                    dismiss_keystroke: Some(yarpui::keymap::Keystroke {
                        key: "escape".to_string(),
                        ..Default::default()
                    }),
