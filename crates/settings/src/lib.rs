...
use yarpui::{AppContext, Entity, ModelContext};
...
impl PublicPreferences {
    ...
    pub fn reload_from_disk(&self) -> Result<(), yarpui_extras::user_preferences::Error> {
        self.0.reload_from_disk()
    }
}

impl yarpui::Entity for PublicPreferences {
    type Event = ();
}

impl yarpui::SingletonEntity for PublicPreferences {}
...
impl yarpui::Entity for PrivatePreferences {
    type Event = ();
}

impl yarpui::SingletonEntity for PrivatePreferences {}
...
pub trait Setting {
    ...
    /// Returns whether and how this setting is synced to the cloud via Yarp Drive.
