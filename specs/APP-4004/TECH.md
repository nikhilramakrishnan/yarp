...
`FeatureFlag::TrimTrailingBlankLines` added to `crates/yarp_features/src/lib.rs`, included in `DOGFOOD_FLAGS`.
...
- `crates/yarp_features/src/lib.rs` — flag enum + DOGFOOD_FLAGS
