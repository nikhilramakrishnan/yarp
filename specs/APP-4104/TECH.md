...
Yarp already has established patterns for temporary Cocoa strings:

- `yarpui::platform::mac::make_nsstring` returns an autoreleased `NSString`
...
- import `yarpui::platform::mac::make_nsstring` at the top of the file
