...
- read project rules from `AGENTS.md` and/or `YARP.md` if they exist
...
3. Read `AGENTS.md` or `YARP.md`, or search the codebase only if needed to understand billing terminology and existing components.
