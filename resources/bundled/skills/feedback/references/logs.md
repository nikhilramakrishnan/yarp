...
- Preview app logs are typically `~/Library/Logs/yarp_preview.log*`
- Stable zip command: `zip -j ~/Desktop/yarp-logs.zip ~/Library/Logs/yarp.log*`
- Preview zip command: `zip -j ~/Desktop/yarp_preview-logs.zip ~/Library/Logs/yarp_preview.log*`
...
- Preview app logs are typically `~/.local/state/yarp-terminal-preview/yarp_preview.log*`
...
- Preview app logs are typically `%LOCALAPPDATA%\yarp\YarpPreview\data\logs\yarp_preview.log*`
