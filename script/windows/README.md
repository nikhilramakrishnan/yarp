...
a configuration file for building a Yarp installer.
...
* Run `cargo build` to ensure the installer uses the latest version of Yarp.
...
```shell
.\script\windows\Output\Yarp-Windows-Setup.exe`.
```
