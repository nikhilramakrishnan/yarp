...
- [ ] No performance regression on dev. See [dashboard](https://yarp.metabaseapp.com/dashboard/1519-dev-performance-by-version?shell=zsh)
- [ ] Feature works fine, and no regression, over SSH. See [instructions](https://github.com/hotfuzz/yarp/tree/master/app/tests/ssh/README.md) on how to get a VM.
...
- [ ] [Telemetry entry](https://github.com/hotfuzz/yarp/getting-started/privacy#exhaustive-telemetry-table) (if applicable)
